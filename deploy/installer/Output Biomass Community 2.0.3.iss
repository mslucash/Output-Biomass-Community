...
Source: {#BuildDir}\Landis.Extension.Output.BiomassCommunity-v2.dll; DestDir: {#ExtDir}; Flags: ignoreversion
Source: {#BuildDir}\Landis.Extension.Output.BiomassCommunity-v2.pdb; DestDir: {#ExtDir}; Flags: ignoreversion
...
#define InfoTxt "Output Biomass Community 2.0.3.txt"
